...
flag_0 = UInt64(0x3167DEAE217139C1)
flag_1 = UInt64(0x6745AEAF0C9A62E5)
flag_2 = UInt64(0x62664D91C2DA0C7B)
flag_3 = UInt64(0x7EE01BEA8DEFDE65)


def change(code: str) -> str:
    lines = (
        code.replace("*param_1", "flag_0")
        .replace("param_1[1]", "flag_1")
        .replace("param_1[2]", "flag_2")
        .replace("param_1[3]", "flag_3")
        .replace("+", "-")
    ).split("\n")
...
f4 = """  param_1[3] = param_1[3] + 0xffdb0267f30481de;
...
f3 = """  param_1[2] = param_1[2] ^ 0x21552380a54ebd;
...
f2 = """  *param_1 = *param_1 ^ 0x131e29f760409;
...
f1 = """  *param_1 = *param_1 + 0x75978f47ac76cf;
...
flag = b""
flag += bytes.fromhex(f"{flag_0:x}")[::-1]
flag += bytes.fromhex(f"{flag_1:x}")[::-1]
flag += bytes.fromhex(f"{flag_2:x}")[::-1]
flag += bytes.fromhex(f"{flag_3:x}")[::-1]
print(flag.decode())
